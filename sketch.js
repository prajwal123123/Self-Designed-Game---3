...
function preload(){
   ...
   monsterballImg = loadImage("images/monster ball.jpg");
}
function setup(){
...
function draw(){
    ...
    drawSprites();
    if(monsterGroup.isTouching(stick)){
...
function spawnMonsters(){
    if(frameCount% 50 ===0){
        monster = createSprite(random(50,400),random(50,500));
        monster.addImage(monsterballImg);
        monster.scale =0.2;
        monster.lifetime= 50;
